...
For the following tables moviesInfo
...
Solution:
My Solution 1 below does a nested select and passes all test cases. A more elegant solution is Solution 2 below, which uses the HAVING clause which allows you to specify a filter condition for groups of rows or aggregates.
*/
